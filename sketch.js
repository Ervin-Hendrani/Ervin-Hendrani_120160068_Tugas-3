...
function setup() {
  ...
  Saturn = new Planet(["Saturn", 116464*2 , 1514.5*2, 1352.5*2, 10759*2, color('jade green')]);
  Uranus = new Planet(["Uranus", 50724*2, 3008*2, 2742*2, 30689*2, color('brown')]);
  Neptune = new Planet(["Neptune", 49244*2, 4540, 4460, 60182, color('cyan')]);
}
